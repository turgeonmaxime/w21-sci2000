...
```
  ...
  - *Interpretation*: the estimated value of $\beta_1$ is `r round(coef(fit)[2], 2)`, which means that two groups of people from the study who differ in their age by 1 year on average differ in their cholesterol levels by `r round(coef(fit)[2], 2)` ml/dl, with being older being associated with higher cholesterol level.
